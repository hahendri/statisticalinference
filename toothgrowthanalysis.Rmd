...
The result is a little further from theoretical, but still pretty close.  Figure two compares 
...
The large distribution of random exponentials is depicted in Figure Three

```{r fig.cap = "Figure Three - histogram of 1000 Random Exponentials"}
...
```{r fig.cap = "Figure Four - histogram of means of 40 observations simulated 1000 times"}
...
Figure Five depicts the distribution of averages from 400 observed random expenetials simulated 1000 times.
...
```{r fig.cap = "Figure Five - histogram of means of 400 observations simulated 1000 times"}
hist(mnsfh, col = "grey", main = "Histogram of means of 400 Random Exponentials Simulated 1000 Times", ylab = "Frequency",
     xlab = "Observed Means", breaks = 100, cex.main = 0.5)
rug(mnsfh)
```

Figure Five shows that as sample size increases, the distribution becomes more normal.
